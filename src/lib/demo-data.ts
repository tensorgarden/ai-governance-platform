...
export const demoComplianceReports: ComplianceReport[] = [
  {
    ...
    evidenceArtifacts: [
      ...
      { id: "art_019", framework: "EU AI Act", control: "Provider instructions-for-use receipt, deployer monitoring-data access, and incident escalation response target for candidate screening", artifactType: "review_record", owner: "People Data Governance", collectedAt: "2026-08-18T09:30:00Z", retention: "10 years", status: "needs_review" },
      { id: "art_020", framework: "EU AI Act", control: "Provider instructions-for-use receipt, monitoring-data export test, and incident escalation response target for credit recommendations", artifactType: "review_record", owner: "Financial AI Records Office", collectedAt: "2026-08-18T10:00:00Z", retention: "10 years", status: "current" },
    ],
  },
  {
    id: "rep_002",
...
export const demoUseCaseInventory: AIUseCaseInventoryItem[] = [
  {
    ...
    oversightReview: {
      ...
      monitoringSignals: [
        { id: "sig_001", name: "Grounded summary sampling", status: "green", lastCheckedAt: "2026-06-08T09:30:00Z", threshold: ">= 95% sampled summaries grounded in approved playbooks", observedValue: "97% grounded", responseOwner: "Customer Success Ops", responseAction: "continue_monitoring", evidenceArtifactIds: ["art_002"] },
      ],
      aiLiteracyReadiness: {
        status: "current",
  ...
  },
  {
    ...
    oversightReview: {
      ...
      monitoringSignals: [
        { id: "sig_002", name: "Adverse impact ratio delta", status: "breach", lastCheckedAt: "2026-06-09T09:00:00Z", threshold: "< 5% swing across protected-class proxy groups", observedValue: "11.4% swing in senior engineering sample, crossing the 5% threshold", correctiveActionDue: "2026-06-12T17:00:00Z", responseOwner: "People Operations AI Review Board", responseAction: "suspend_and_notify", evidenceArtifactIds: ["art_001", "art_009"] },
        { id: "sig_003", name: "Recruiter override review coverage", status: "green", lastCheckedAt: "2026-06-09T09:15:00Z", threshold: "100% AI-ranked shortlists sampled by accountable recruiter", observedValue: "100% sampled with named reviewer", responseOwner: "People Operations Recruiting", responseAction: "continue_monitoring", evidenceArtifactIds: ["art_002"] },
        { id: "sig_007", name: "Protected-class parity audit — senior engineering", status: "breach", lastCheckedAt: "2026-06-11T11:00:00Z", threshold: "Selection rate within 80% of the most-selected group across all protected-class proxies", observedValue: "71% parity in senior engineering sample; system use suspended pending investigation", correctiveActionDue: "2026-06-18T17:00:00Z", responseOwner: "People Operations AI Review Board", responseAction: "suspend_and_notify", evidenceArtifactIds: ["art_001", "art_009"] },
      ],
      aiLiteracyReadiness: {
      ...
      inputDataReadiness: {
        status: "needs_action",
        controlCoverage: "partial",
        assessedDatasets: ["Applicant evidence profiles", "Role requirement library"],
        relevanceBasis: "Inputs must map directly to documented role requirements and exclude protected-class proxies from ranking.",
        representativenessChecks: ["Selection-rate comparison by job family", "Accommodation-path coverage review"],
        unresolvedGaps: ["Graduate hiring sample is too small for stable job-family comparison"],
        dataOwner: "People Data Governance",
        lastVerifiedAt: "2026-07-30T14:30:00Z",
      ...
      providerEvidenceReadiness: {
        status: "needs_action",
        instructionsForUseVersion: "OpenAI recruitment recommendations instructions v2.4",
        technicalDocumentationAvailable: false,
        monitoringDataAccess: "partial",
        incidentContactRoute: "Enterprise Trust incident portal with an HR AI escalation route",
        providerResponseTargetHours: 24,
        missingEvidence: ["Provider post-market monitoring data export for deployment-level drift", "Written investigation response target for deployer-raised serious incidents"],
        accountableOwner: "People Data Governance",
        lastVerifiedAt: "2026-08-18T09:30:00Z",
        remediationDueAt: "2026-08-29T17:00:00Z",
        evidenceArtifactIds: ["art_017", "art_019"],
      },
      seriousIncidentEscalation: {
  ...
  },
  {
    ...
    oversightReview: {
      ...
      postMarketMonitoring: true,
      monitoringSignals: [
        { id: "sig_004", name: "Explanation drift review", status: "watch", lastCheckedAt: "2026-06-09T10:20:00Z", threshold: "< 3 unresolved explanation mismatches per week", observedValue: "3 unresolved mismatches awaiting risk committee sign-off", correctiveActionDue: "2026-06-14T17:00:00Z", responseOwner: "Finance Risk Committee", responseAction: "remediate", evidenceArtifactIds: ["art_004", "art_009"] },
        { id: "sig_005", name: "Human approval sampling", status: "green", lastCheckedAt: "2026-06-09T10:35:00Z", threshold: "100% adverse-action drafts approved before customer impact", observedValue: "100% approval gate coverage", responseOwner: "Finance Risk Operations", responseAction: "continue_monitoring", evidenceArtifactIds: ["art_001"] },
      ],
      aiLiteracyReadiness: {
        status: "current",
      ...
      inputDataReadiness: {
        status: "ready",
        controlCoverage: "complete",
        assessedDatasets: ["Verified financial statements", "Governed repayment history"],
        relevanceBasis: "Only current affordability and repayment evidence approved for the credit-line purpose enters recommendation context.",
        representativenessChecks: ["Portfolio coverage by business size", "Missing-data rate by application channel"],
        unresolvedGaps: [],
      ...
      providerEvidenceReadiness: {
        status: "ready",
        instructionsForUseVersion: "Anthropic credit recommendation instructions v3.1",
        technicalDocumentationAvailable: true,
        monitoringDataAccess: "full",
        incidentContactRoute: "Anthropic Enterprise Trust portal with regulated-use escalation",
        providerResponseTargetHours: 12,
        missingEvidence: [],
        accountableOwner: "Financial AI Records Office",
        lastVerifiedAt: "2026-08-18T10:00:00Z",
        evidenceArtifactIds: ["art_001", "art_020"],
      },
      seriousIncidentEscalation: {
  ...
  },
  {
    ...
    oversightReview: {
      ...
      postMarketMonitoring: false,
      monitoringSignals: [
        { id: "sig_006", name: "Localization bias sampling", status: "green", lastCheckedAt: "2026-06-03T11:00:00Z", threshold: "No high-severity brand or demographic bias findings in weekly sample", observedValue: "0 high-severity findings", responseOwner: "Marketing Compliance", responseAction: "continue_monitoring", evidenceArtifactIds: ["art_003"] },
      ],
      aiLiteracyReadiness: {
        status: "current",
